        ...
        <div className="space-y-6">
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <p className="text-muted-foreground">Manage office visitors and appointments.</p>
                </div>
                ...
                <div className="lg:col-span-3">
                    <div className="rounded-xl border bg-card text-card-foreground shadow p-6">
                        ...
                        <div className="space-y-2">
                            <Link href="/official/passes" className="block text-sm text-primary hover:underline">View all my passes</Link>
                            <Link href="/official/passes/new" className="block text-sm text-primary hover:underline">Create a new pass</Link>
                        </div>
                    </div>
                </div>
            </div>
