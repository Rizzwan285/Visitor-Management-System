...
export function OfficialPassForm() {
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            toast.success('Official visitor pass created successfully!');
            router.push(`/official/passes/${result.id}`);
        } catch (error: any) {
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
            <div className="space-y-4">
                <div className="space-y-2">
                    ...
                    <Input id="visitorName" name="visitorName" placeholder="Full name of the official visitor" required />
                </div>
                ...
                <div className="space-y-2">
                    <Label htmlFor="purpose">Purpose of Visit (Official)</Label>
                    <Textarea id="purpose" name="purpose" placeholder="Briefly describe the official reason for the visit" required />
                </div>
